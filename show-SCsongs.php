...
<html lang="en">
  <head>
    ...
    <button><a href ="index.html">Home</button></a><button><a href ="show-SCartists.php">Artist Catalog</button></a><button><a href ="show-SCalbums.php">Album Catalog</button></a>
<style>
  body{
